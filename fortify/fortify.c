...
#endif
                (void*)(ptr + FORTIFY_HEADER_SIZE + FORTIFY_ALIGNED_BEFORE_SIZE), file, line);
        st_Output(st_Buffer);
...
#else
            sprintf(st_Buffer, "\n%p %8lu ", (void*)ptr, (unsigned long)offset);
#endif
            st_Output(st_Buffer);
        }
...
#endif
	                       (void*)((unsigned char*)h + FORTIFY_HEADER_SIZE + FORTIFY_ALIGNED_BEFORE_SIZE),
...
#endif
    	        (void*)((char*)h + FORTIFY_HEADER_SIZE + FORTIFY_ALIGNED_BEFORE_SIZE),
